 ...
 */
export function allowed(message?: string): AdmissionResponse;
/**
 * denied() constructs a response indicating that the given operation is denied.
 * @param {string} [message] additional message to attach to the response.
 * @returns {AdmissionResponse}
 */
export function denied(message?: string): AdmissionResponse;
/**
 ...
 * @returns {AdmissionResponse}
 */
export function errored(code: number, err?: Error): AdmissionResponse;
/**
 ...
 * @returns {AdmissionResponse}
 */
export function validationResponse(allowed: boolean, message?: string): AdmissionResponse;
/**
...
export type AdmissionRequestOptions = {
    /**
...
export type AdmissionResponseOptions = {
    /**
     * uid is an identifier for the individual request/response.
     */
    uid?: string;
...
export type AdmissionReviewOptions = {
    /**
